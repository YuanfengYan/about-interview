...
## 基础知识
  ...
  7. ✅ map和object区别  
  8. ✅promise 、async await 、callback区别[js异步解决方案比较](./md/js异步解决方案比较.md)  
  ...
  18. js原型链理解  
  19. Cookie、Session、Token、JWT区别[传送门](https://juejin.im/post/6844904034181070861#heading-2)  
...
## 框架知识
  ...
  8. vue中v-model实现原理
  9. vue中nextTick实现
  10. angular 的基本应用[传送门](./md/frame/angular基础知识.md)
...
## 优化方案
  ...
  4. 小程序和Vue数据绑定的区别
  5. GPU加速方案，主动触发
  6. js内存性能优化：对象池（降低垃圾回收的频率）、使用let const可以尽快回收该回收的内存、隐藏类和删除类、避免内存泄漏
...
## 最近了解的
  ...
  1. webRTC 通信 peerconnection ice协议 sip协议
  2. websocket 信令服务
  3. electron桌面应用
